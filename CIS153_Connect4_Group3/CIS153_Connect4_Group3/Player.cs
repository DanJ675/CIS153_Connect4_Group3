...
namespace CIS153_Connect4_Group3
{
    class Player
    {
        ...
        public void setWins(int num) { wins = num; }
        public void setLosses(int num) { losses = num; }
        public void setTies(int num) { ties = num; }
        public void setWinsVsAi(int num) { winsVsAi = num; }
        public void setLossesVsAi(int num) { lossesVsAi = num; }
        public void setTiesVsAi(int num) { tiesVsAi = num; }
